# A map of planning considerations

The [wiki](wiki) directory contains a markdown file for each concept mapped, which can be opened as an [Obsidian](https://obsidian.md/) vault.
